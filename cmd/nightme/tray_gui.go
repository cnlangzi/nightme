...
//     Note that this guard only covers a MISSING DISPLAY, not
//     missing GTK libraries — a binary built with -tags gui on a
//     host without libayatana-appindicator3.so.1 dies in ld.so
//     before any Go code runs. That is precisely why the default
//     Linux artifact is built without this file.
//
// Menu layout:
//
