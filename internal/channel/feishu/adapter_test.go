...
func TestSend_OutResult_OrphanTopLevel(t *testing.T) {
	...
	ctx := &gateway.StatusBar{
		...
		UsageBar: &gateway.UsageStatusBar{UsageInfo: &agent.UsageInfo{InputTokens: 200, OutputTokens: 80, CostUSD: 0.456}},
	}
	text := "## Final\n\nbody"
	if err := a.Send(t.Context(), gateway.OutboundMessage{
		Kind:           gateway.OutResult,
...
func TestSend_OutReply_ColdStartSendCardFails_StillProducesCard(t *testing.T) {
	...
	if err := a.Send(context.Background(), gateway.OutboundMessage{
		...
		StatusBar: &gateway.StatusBar{
			AgentBar: &gateway.AgentStatusBar{Agent: "claude", Model: "opus-4-5"},
			UsageBar: &gateway.UsageStatusBar{UsageInfo: &agent.UsageInfo{InputTokens: 10, CostUSD: 0.001}},
		},
	}); err != nil {
...
func TestSend_OutReply_AppendEntryOverflow_StillProducesCard(t *testing.T) {
	...
	ctx := &gateway.StatusBar{
		AgentBar: &gateway.AgentStatusBar{Agent: "claude", Model: "opus-4-5"},
		UsageBar: &gateway.UsageStatusBar{UsageInfo: &agent.UsageInfo{InputTokens: 100, CostUSD: 0.01}},
	}
...
func TestSend_OutTask_OrphanReplyTo_StillCard(t *testing.T) {
	...
	if err := a.Send(context.Background(), gateway.OutboundMessage{
		...
		StatusBar: &gateway.StatusBar{
			AgentBar: &gateway.AgentStatusBar{Agent: "claude", Model: "opus-4-5"},
			UsageBar: &gateway.UsageStatusBar{UsageInfo: &agent.UsageInfo{InputTokens: 100, CostUSD: 0.001}},
		},
	}); err != nil {
...
func TestSend_OutTask_ColdStartSendCardFails_StillCard(t *testing.T) {
	...
	if err := a.Send(context.Background(), gateway.OutboundMessage{
		...
		StatusBar: &gateway.StatusBar{
			AgentBar: &gateway.AgentStatusBar{Agent: "claude", Model: "opus-4-5"},
			UsageBar: &gateway.UsageStatusBar{UsageInfo: &agent.UsageInfo{InputTokens: 50, CostUSD: 0.005}},
		},
	}); err != nil {
