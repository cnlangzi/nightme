...
// recordingAgent is a minimal agent.Agent for the dispatcher tests.
// It captures RunOnce calls and returns a configurable (text, err)
// pair. Lives in this test file (not registry_test.go) because the
// gtw tests need a fake that satisfies agent.Agent; the agent
// package's fakes are too tightly coupled to registry semantics.
...
func (r *recordingAgent) Mode() agent.Mode { return agent.ModePTY }
func (r *recordingAgent) Command() string  { return "fake-" + r.name }
func (r *recordingAgent) Args() []string   { return nil }
func (r *recordingAgent) Env() []string    { return nil }
...
func (r *recordingAgent) Events() <-chan agent.AgentEvent             { return nil }
func (r *recordingAgent) PID() int                                    { return 99999 }
func (r *recordingAgent) SendText(string) error                       { return nil }
func (r *recordingAgent) SendBlocks(context.Context, []agent.ContentBlock) error {
	return nil
}
func (r *recordingAgent) SendPermission(string) error { return nil }
func (r *recordingAgent) New(context.Context) error   { return nil }
