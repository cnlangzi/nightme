...
func TestRunHooks_Empty(t *testing.T) {
	got := RunHooks(context.Background(), nil, t.TempDir())
	if got != nil {
...
func TestWithHooks_BeforeAndAfterFire(t *testing.T) {
	...
	err := f.withHooks(context.Background(), cs, "chat-1", "msg-1", LoadNotes{},
...
func TestWithHooks_NoHooksNoReply(t *testing.T) {
	...
	_ = f.withHooks(context.Background(), cs, "chat-1", "msg-1", LoadNotes{},
...
func TestWithHooks_LoadNotesInReply(t *testing.T) {
	...
	_ = f.withHooks(context.Background(), cs, "chat-1", "msg-1", notes,
		nil, nil, func() error { return nil })
