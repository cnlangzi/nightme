// Package feishu — registers the feishu login Provider in the
// login registry. cmd/nightme imports this package so init()
// runs at process start, exposing `nightme login feishu`.
//
